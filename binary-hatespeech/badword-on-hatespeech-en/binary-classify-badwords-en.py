...
neg_df = pd.read_csv('/nas.dbms/fathan/test/multilang-hate-models/binary-hatespeech/final_preprocessed_data_yidong_devansh.csv', header=None, names=['text', 'hs_class'])

neg_df['text'] = neg_df['text'].astype(str)
neg_df['hs_class'] = pd.to_numeric(neg_df['hs_class'], errors='coerce')

neg_df.dropna(subset=['hs_class'], inplace=True)

neg_df['hs_class'] = neg_df['hs_class'].astype(int)
neg_df['hs_class'] = neg_df['hs_class'].map({1: 'positive', 0: 'negative'})
...
neg_df.info()
neg_df.sample(5)
print(neg_df['hs_class'].value_counts())

# hs_class is 'negative' WITHOUT SEXUAL WORD 
neg_df = pd.read_csv('/nas.dbms/fathan/test/multilang-hate-models/binary-hatespeech/badword-on-hatespeech-en/negative_hatespeech_without_sexual_words.csv')
...
# pos_df = pd.read_csv('/nas.dbms/fathan/test/multilang-hate-models/binary-hatespeech/badword-on-hatespeech-en/positive_hatespeech_with_sexual_words.csv')
